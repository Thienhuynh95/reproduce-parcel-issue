...
var bundlePackage = function (options) { return __awaiter(void 0, void 0, void 0, function () {
    var defaultOptions, configOptions, bundler, bundleGraph, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                configOptions = __assign(__assign({}, defaultOptions), options);
                bundler = new Parcel(configOptions);
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, bundler.run()];
            case 2:
                bundleGraph = (_a.sent()).bundleGraph;
                return [3 /*break*/, 4];
            case 3:
                err_1 = _a.sent();
